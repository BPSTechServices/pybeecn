...
-------------------------------------------------------------
    ...
    polygon_url = '{}'.format(args.boundaries)
    ...
    bn.plot_beecn_png(points_url, polygon_url, plot_dir, show=args.show if args.show else False)

    population_csv = args.filePath
    column=args.column
    bn.plot_beecn_html(polygon_url, plot_dir, points_url, population_csv, population_column=column)
